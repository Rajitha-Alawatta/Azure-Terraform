module "nginx-sample-app" {
  ...
  nginx_pod_count         = "1"                    # NGINX application replicas - No. of containers
  ...
  storage_account_name    = "tfstatenginxdevtest"  # Azure storage account name - This can be any name but globally unique
